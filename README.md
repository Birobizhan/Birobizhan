...
<p align="center">
  <b>Я бэкэнд разработчик на python💻</b><br>
...
| --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [Pomodoro service](https://github.com/Birobizhan/pomodoro)                                                | Помодоро API приложение с использованием кэширования, отправки уведомлений на почту, покрытый тестами + CI/CD                                         | FastAPI, PostgreSQL, Celery, Docker, RabbitMQ, Redis                     |
| AI test assistant                                                                                         | Расширение для браузера с нейросетью для решения тестов с возможностью загрузки скриншотов, выставления оценок ответу и админ панелью                 | FastAPI, PostgreSQL, Docker, JS+HTML+CSS для расширения, openai, pgadmin |
| Расчет маршрутов и статистики для экологической компании                                                  | Расчет различных статистических метрик по файлам с точками маршрутов (150к+ маршрутов, 8кк+ точек маршрутов), создание и расчет оптимальных маршрутов | Pandas, Matplotlib, Docker, OpenStreetMaps, Numpy                        |
| [ToDoApp](https://github.com/Birobizhan/ToDoApp)                                                          | Приложение для ведения заметок или задач, разделенный на api и web части                                                                              | FastAPI, PostgreSQL, HTML, CSS                                           |
| [Movie recommender](https://github.com/Birobizhan/movie_recommender)                                      | Телеграмм бот для подбора фильма для просмотра с получением данных с помощью AI                                                                       | AIogram, bs4, openai, pandas, numpy                                      |
